...
class _HomeScreenState extends State<HomeScreen> {
      ...
      slivers: <Widget>[
        ...
        SliverList(
          delegate: SliverChildListDelegate([
            _buildDiscoverOurCollection(size),
            buildRecommendedForYou(size),
          ]),
        ),
      ],
    );
  ...
  List<Widget> _carouselSliderCardItems(Size size) {
  ...
  Widget _buildDiscoverOurCollection(Size size) {
    return Container(
          ...
          Expanded(
            child: Container(
              ...
              child: CarouselSlider(
                ...
                items: _carouselSliderCardItems(size),
              ),
            ),
          ),
        ],
  ...
  Widget buildRecommendedForYou(Size size) {
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Expanded(
                  child: Image(
                    image: AssetImage("assets/images/menu/home/museum.jpg"),
                    fit: BoxFit.fill,
                  ),
                ),
                Expanded(
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(height: 3),
                            Text(
                              "Ini adalah  text yang sangat panjagn sehingga dapat menjadikan text overflowing",
                              maxLines: 3,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.start,
                              style: TextStyle(
